...
$context['sidebar']           = ( 'social-ecologies' === $timber_post->post_name || 'spontaneous-vegetation' === $timber_post->post_name ) ? null : Timber::get_sidebar( 'sidebar.php', $sidebar_context );
